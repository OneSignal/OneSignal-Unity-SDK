...
namespace Com.OneSignal.IOS.Editor
{
   public static class BuildPostProcessor
   {
      ...
      public static readonly string IOS_RESOURCES_FOLDER = "com.onesignal.unity.ios/Plugins/iOS/";
      public static readonly string PACKAGE_IOS_RESOURCES_FOLDER = $"Packages/{IOS_RESOURCES_FOLDER}";
      ...
      private static void AddNotificationServiceExtension(PBXProject project, string path)
      {
         ...
         project.AddBuildProperty(extensionGUID, "LIBRARY_SEARCH_PATHS", $"$(PROJECT_DIR)/Libraries/{IOS_RESOURCES_FOLDER}");
         project.WriteToFile(projectPath);
      ...
      private static bool CreateNotificationExtensionPlistFile(string path)
      {
         ...
         var plistPath = Path.GetFullPath($"{PACKAGE_IOS_RESOURCES_FOLDER}info.plist");
