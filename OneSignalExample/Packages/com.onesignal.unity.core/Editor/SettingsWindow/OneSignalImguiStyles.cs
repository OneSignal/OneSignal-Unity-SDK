...
static class OneSignalImguiStyles
{
    ...
    public static Color DisabledImageColor =>
        EditorGUIUtility.isProSkin ? ProDisabledImageColor : GetColorFromHtml("#3C3C3CFF");
    ...
    public static GUIStyle SeparationStyle
    {
        get
        {
            ...
            if (s_SeparationStyle.normal.background == null)
                s_SeparationStyle.normal.background =
                    GetIconFromHtmlColorString(EditorGUIUtility.isProSkin ? "#292929FF" : "#A2A2A2FF");
    ...
    public static GUIStyle ServiceBlockHeader => s_ServiceBlockHeader
                                                 ?? (s_ServiceBlockHeader = new GUIStyle
                                                 {
