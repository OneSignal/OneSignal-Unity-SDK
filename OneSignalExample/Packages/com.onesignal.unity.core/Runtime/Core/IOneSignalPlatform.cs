...
namespace Com.OneSignal
{
    ...
    {
        void Init();
        void SetLogLevel(OneSignalPush.LOG_LEVEL logLevel, OneSignalPush.LOG_LEVEL visualLevel);
        ...
        void SetInFocusDisplaying(OneSignalPush.OSInFocusDisplayOption display);
