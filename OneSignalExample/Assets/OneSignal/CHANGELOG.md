...
- Updated included Android SDK from 5.1.37 to [5.3.0-alpha-01](https://github.com/OneSignal/OneSignal-Android-SDK/releases/tag/5.3.0-alpha-01)
  - For full changes, see the [native release notes](https://github.com/OneSignal/OneSignal-Android-SDK/releases)
- Updated included iOS SDK from 5.2.14 to [5.4.0-alpha-01](https://github.com/OneSignal/OneSignal-iOS-SDK/releases/tag/5.4.0-alpha-01)
...
- [Migration guide](https://github.com/OneSignal/OneSignal-Unity-SDK/blob/5.0.0-beta.1/MIGRATION_GUIDE_v3_to_v5.md) for updating from 3.x.x to 5.x.x
...
[Unreleased]: https://github.com/OneSignal/OneSignal-Unity-SDK/compare/5.2.0-beta-01...HEAD
[5.2.0-beta-01]: https://github.com/OneSignal/OneSignal-Unity-SDK/compare/5.2.0-beta-01...5.2.0-beta-01
[5.2.0-beta-01]: https://github.com/OneSignal/OneSignal-Unity-SDK/compare/5.1.15...5.2.0-beta-01
