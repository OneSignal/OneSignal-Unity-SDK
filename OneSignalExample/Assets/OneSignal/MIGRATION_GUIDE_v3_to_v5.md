...
| `Dictionary<string, string> GetTags()`                | *Return a copy of all tags for the current user. Tags are key:value pairs used as building blocks for targeting specific users and/or personalizing messages.*         |
