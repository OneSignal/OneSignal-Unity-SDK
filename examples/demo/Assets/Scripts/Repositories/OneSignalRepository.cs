...
namespace OneSignalDemo.Repositories
{
    public class OneSignalRepository
    {
        ...
        public void AddAliases(Dictionary<string, string> aliases) => OneSignal.User.AddAliases(aliases);
        ...
        public void AddTriggers(Dictionary<string, string> triggers) => OneSignal.InAppMessages.AddTriggers(triggers);
        public void RemoveTrigger(string key) => OneSignal.InAppMessages.RemoveTrigger(key);
        public void RemoveTriggers(List<string> keys) => OneSignal.InAppMessages.RemoveTriggers(keys.ToArray());
